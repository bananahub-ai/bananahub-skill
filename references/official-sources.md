...
### 2. Google DeepMind Prompt Guide
...
### 3. Google Developers Blog — 提示词最佳实践
...
### 6. Nano Banana 2 (Gemini 3.1 Flash Image)
...
### 8. Efficient Coder — Gemini Flash Image Prompting Guide
...
### 9. DataCamp — Gemini 2.5 Flash Image Complete Guide
- **URL**: https://www.datacamp.com/tutorial/gemini-2-5-flash-image-guide
- **内容**: 教程级别的完整指南（需登录访问）

### 10. eWeek — Best Nano Banana 2 Prompts 2026
